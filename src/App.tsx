...
import TiposContrato from "./pages/Configuracoes/tabelasAuxiliares/TiposContrato";
import Departamentos from "./pages/Configuracoes/tabelasAuxiliares/Departamentos";
...
*/}
            ...
            <Route path="configuracoes">
              <Route path="tabelas-auxiliares" element={<TabelasAuxiliares />}>
                <Route index element={<Navigate to="tipos-contrato" replace />} />
                <Route path="tipos-contrato" element={<TiposContrato />} />
